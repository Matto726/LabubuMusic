...
def _generate_nav_buttons(_, start_mode):
    """Internal helper for navigation row."""
    back_data = "settingsback_helper" if start_mode else "close"
    back_text = _["BACK_BUTTON"] if start_mode else _["CLOSE_BUTTON"]
...
def help_pannel_page1(_, START: Union[bool, str] = None):
    menu = [
        [
        ...
        _generate_nav_buttons(_, START)
    ]
    return InlineKeyboardMarkup(menu)

def help_pannel_page2(_, START: Union[bool, str] = None):
    menu = [
        [
...
def help_pannel_page3(_, START: Union[bool, str] = None):
    menu = [
        [
...
def help_pannel_page4(_, START: Union[bool, str] = None):
    menu = [
        [
...
def private_help_panel(_):
    return [
        [
            InlineKeyboardButton(
                text=_["S_B_4"],
                url=f"https://t.me/{matto_bot.username}?start=help",
            )
        ]
    ]